...
public class Steps {
	...
	AddContactPage addcontactpage;
	 ...
	 public void user_is_on_Home_Page(){
		 System.out.println("In the browser page");
	 System.setProperty("webdriver.chrome.driver","C:\\Users\\sudheerkumarn\\Documents\\Drivers\\chromedriver_win32\\chromedriver.exe");
	 driver = new ChromeDriver();
	 driver.manage().window().maximize();
	 driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
	 //driver.get("http://www.shop.demoqa.com");
	 driver.get("http://10.7.177.173:8083/");
	 ...
	 public void click_on_new_contact() throws Exception {
